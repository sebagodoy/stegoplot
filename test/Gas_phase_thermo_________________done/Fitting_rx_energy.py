...
# Define plot
fig, [axCO, axCO2] = plt.subplots(2,1, sharex='col', figsize=(5.8,6.))
plt.subplots_adjust(hspace=0., right=.96, top=.96, left=.15, bottom=.08)
...
for iax in [axCO2, axCO]:
	iax.legend(loc='center right', ncol=3, prop={'size': 8}, bbox_to_anchor=(.98, .35))
...
plt.savefig('./Fitting_rx_energy.png')
