...
class AdsItem(SingleItem):
    def __init__(self, **kwargs):
        stegoplot.item_types.SingleItem.__init__(self, **{**kwargs, 'type': 'Adsorbed'})
    ...
    def q_tras(self, Report=False, **_unused) -> 'float, Adim':
        ...
        stegoplot.promps.report(Report, 'q_tras', 1., self)
        return 1
    ...
    def q_vib(self, T, Report=False, **_unused) -> 'float, Adim':
        try:
            ...
            stegoplot.promps.report(Report, 'q_vib', out, self)
            return out
        except TypeError:
    ...
    def q_el(self, Report=False, **_unused):
        ...
        stegoplot.promps.report(Report, 'q_el', 1., self)
        return 1
    ...
    def Etras(self, T=None, Report=False, **_unused):
        ...
        stegoplot.promps.report(Report, 'E. tras.', 0., self)
        return 0

    def Erot(self, T=None, Report=False, **_unused) -> 'float, eV':
        # Surface does not rotate
        stegoplot.promps.report(Report, 'E. rot.', 0., self)
        return 0.
    ...
    def Stras(self, T=None, P=None, Report=False):
        # Surface does not move
        stegoplot.promps.report(Report, 'S. tras.', 0., self)
        return 0
